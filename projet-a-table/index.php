...
include "table1.php"?>
<header>
	<h1><img src="assets/img/pizza.png">BDD : projet resto<img src="assets/img/watermelon (1).png"></h1>
	...
	<table class = "global">
			...
			<?php
				...
				"	<tr>
						<td colspan='4' class='h3'>
							<h3 class='statglobales'>Stats</h3>
						</td>
					</tr>
					<tr>
		...
		<?php while($row = $stmt3->fetch(PDO::FETCH_ASSOC)) : ?>
			<?php
				...
				"
					<tr>
						<td colspan ='2'>Nombre de téléphone de la marque: <u>nokia</u>
						</td>
						<td>/
						</td>";
						echo
						"<td>
							<span class='result'>" . ($row['nbre_de_telephone_nokia']) .
							"</span>
						</td>
					</tr>
				";
